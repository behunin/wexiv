...
constexpr TagDetails pentaxQuality[] = {
    {0, N_("Good")}, {1, N_("Better")}, {2, N_("Best")}, {3, N_("TIFF")}, {4, N_("RAW")}, {5, N_("Premium")}, {65535, N_("n/a")},
};
...
constexpr TagDetails pentaxSaturation[] = {
    {0, N_("Low")},       {1, N_("Normal")}, {2, N_("High")}, {3, N_("Med Low")},  {4, N_("Med High")}, {5, N_("Very Low")},
    {6, N_("Very High")}, {7, N_("-4")},     {8, N_("+4")},   {65535, N_("None")}, {65535, N_("None")} // To silence compiler warning
};
...
constexpr TagDetails pentaxCities[] = {
    {0, N_("Pago Pago")},     {1, N_("Honolulu")},      {2, N_("Anchorage")},     {3, N_("Vancouver")},       {4, N_("San Fransisco")},
    {5, N_("Los Angeles")},   {6, N_("Calgary")},       {7, N_("Denver")},        {8, N_("Mexico City")},     {9, N_("Chicago")},
    {10, N_("Miami")},        {11, N_("Toronto")},      {12, N_("New York")},     {13, N_("Santiago")},       {14, N_("Caracus")},
    {15, N_("Halifax")},      {16, N_("Buenos Aires")}, {17, N_("Sao Paulo")},    {18, N_("Rio de Janeiro")}, {19, N_("Madrid")},
    {20, N_("London")},       {21, N_("Paris")},        {22, N_("Milan")},        {23, N_("Rome")},           {24, N_("Berlin")},
    {25, N_("Johannesburg")}, {26, N_("Istanbul")},     {27, N_("Cairo")},        {28, N_("Jerusalem")},      {29, N_("Moscow")},
    {30, N_("Jeddah")},       {31, N_("Tehran")},       {32, N_("Dubai")},        {33, N_("Karachi")},        {34, N_("Kabul")},
    {35, N_("Male")},         {36, N_("Delhi")},        {37, N_("Colombo")},      {38, N_("Kathmandu")},      {39, N_("Dacca")},
    {40, N_("Yangon")},       {41, N_("Bangkok")},      {42, N_("Kuala Lumpur")}, {43, N_("Vientiane")},      {44, N_("Singapore")},
    {45, N_("Phnom Penh")},   {46, N_("Ho Chi Minh")},  {47, N_("Jakarta")},      {48, N_("Hong Kong")},      {49, N_("Perth")},
    {50, N_("Beijing")},      {51, N_("Shanghai")},     {52, N_("Manila")},       {53, N_("Taipei")},         {54, N_("Seoul")},
    {55, N_("Adelaide")},     {56, N_("Tokyo")},        {57, N_("Guam")},         {58, N_("Sydney")},         {59, N_("Noumea")},
    {60, N_("Wellington")},   {61, N_("Auckland")},     {62, N_("Lima")},         {63, N_("Dakar")},          {64, N_("Algiers")},
    {65, N_("Helsinki")},     {66, N_("Athens")},       {67, N_("Nairobi")},      {68, N_("Amsterdam")},      {69, N_("Stockholm")},
    {70, N_("Lisbon")},       {71, N_("Copenhagen")},   {72, N_("Warsaw")},       {73, N_("Prague")},         {74, N_("Budapest")},
};

//! ImageProcessing, combi-tag 0x0032 (4 bytes)
constexpr TagDetails pentaxImageProcessing[] = {{0x00000000, N_("Unprocessed")},     {0x00000004, N_("Digital Filter")},
                                                {0x01000000, N_("Resized")},         {0x02000000, N_("Cropped")},
                                                {0x04000000, N_("Color Filter")},    {0x06000000, N_("Digital Filter 6")},
...
std::ostream& PentaxMakerNote::printShutterCount(std::ostream& os, const Value& value, const ExifData* metadata) {
  ...
  if (dateIt == metadata->end() || dateIt->size() != 4 || timeIt == metadata->end() || timeIt->size() != 3 || value.size() != 4) {
    os << "undefined";
    return os;
  }
  const uint32_t date = (dateIt->toLong(0) << 24) + (dateIt->toLong(1) << 16) + (dateIt->toLong(2) << 8) + (dateIt->toLong(3) << 0);
  const uint32_t time = (timeIt->toLong(0) << 24) + (timeIt->toLong(1) << 16) + (timeIt->toLong(2) << 8);
  const uint32_t countEnc = (value.toLong(0) << 24) + (value.toLong(1) << 16) + (value.toLong(2) << 8) + (value.toLong(3) << 0);
...
// ----------------------------------------------------------------------
{
  try {
    ...
    if (value.count() == 4) {
      ...
      if (model.rfind("PENTAX K-3", 0) == 0 && lensInfo->count() == 128 && lensInfo->toLong(1) == 168 && lensInfo->toLong(2) == 144)
        index = 7;
    }
...
constexpr TagInfo PentaxMakerNote::tagInfo_[] = {
    {0x0000, "Version", N_("Version"), N_("Pentax Makernote version"), pentaxId, makerTags, undefined, -1, printVersion},
    {0x0001, "Mode", N_("Shooting mode"), N_("Camera shooting mode"), pentaxId, makerTags, unsignedShort, -1,
     EXV_PRINT_TAG(pentaxShootingMode)},
    {0x0002, "PreviewResolution", N_("Resolution of a preview image"), N_("Resolution of a preview image"), pentaxId, makerTags,
     undefined, -1, printResolution},
    {0x0003, "PreviewLength", N_("Length of a preview image"), N_("Size of an IFD containing a preview image"), pentaxId, makerTags,
     undefined, -1, printValue},
    {0x0004, "PreviewOffset", N_("Pointer to a preview image"), N_("Offset to an IFD containing a preview image"), pentaxId, makerTags,
     undefined, -1, printValue},
    {0x0005, "ModelID", N_("Model identification"), N_("Pentax model identification"), pentaxId, makerTags, unsignedShort, -1,
     EXV_PRINT_TAG(pentaxModel)},
    ...
    {0x0009, "Size", N_("Image size"), N_("Image size settings"), pentaxId, makerTags, unsignedLong, -1, EXV_PRINT_TAG(pentaxSize)},
    /* Some missing ! */
    {0x000c, "Flash", N_("Flash mode"), N_("Flash mode settings"), pentaxId, makerTags, unsignedLong, -1, EXV_PRINT_TAG(pentaxFlash)},
    ...
    /* Some missing ! */
    {0x0012, "ExposureTime", N_("Exposure time"), N_("Exposure time"), pentaxId, makerTags, unsignedLong, -1, printExposure},
    ...
    /* Some missing ! */
    {0x0016, "ExposureCompensation", N_("Exposure compensation"), N_("Exposure compensation"), pentaxId, makerTags, unsignedLong, -1,
     printCompensation},
    /* Some missing ! */
    {0x0017, "MeteringMode", N_("MeteringMode"), N_("MeteringMode"), pentaxId, makerTags, undefined, -1,
     EXV_PRINT_TAG(pentaxMeteringMode)},
    {0x0018, "AutoBracketing", N_("AutoBracketing"), N_("AutoBracketing"), pentaxId, makerTags, undefined, -1, printBracketing},
    ...
    {0x001b, "BlueBalance", N_("Blue balance"), N_("Blue color balance"), pentaxId, makerTags, unsignedLong, -1, printValue},
    {0x001c, "RedBalance", N_("Red balance"), N_("Red color balance"), pentaxId, makerTags, unsignedLong, -1, printValue},
    ...
    {0x001f, "Saturation", N_("Saturation"), N_("Saturation"), pentaxId, makerTags, undefined, -1, EXV_PRINT_TAG(pentaxSaturation)},
    {0x0020, "Contrast", N_("Contrast"), N_("Contrast"), pentaxId, makerTags, undefined, -1, EXV_PRINT_TAG(pentaxContrast)},
    {0x0021, "Sharpness", N_("Sharpness"), N_("Sharpness"), pentaxId, makerTags, undefined, -1, EXV_PRINT_TAG(pentaxSharpness)},
    {0x0022, "Location", N_("Location"), N_("Location"), pentaxId, makerTags, undefined, -1, EXV_PRINT_TAG(pentaxLocation)},
    {0x0023, "Hometown", N_("Hometown"), N_("Home town"), pentaxId, makerTags, undefined, -1, EXV_PRINT_TAG(pentaxCities)},
    {0x0024, "Destination", N_("Destination"), N_("Destination"), pentaxId, makerTags, undefined, -1, EXV_PRINT_TAG(pentaxCities)},
    {0x0025, "HometownDST", N_("Hometown DST"), N_("Whether day saving time is active in home town"), pentaxId, makerTags, undefined,
     -1, EXV_PRINT_TAG(pentaxYesNo)},
    {0x0026, "DestinationDST", N_("Destination DST"), N_("Whether day saving time is active in destination"), pentaxId, makerTags,
     undefined, -1, EXV_PRINT_TAG(pentaxYesNo)},
    {0x0027, "DSPFirmwareVersion", N_("DSPFirmwareVersion"), N_("DSPFirmwareVersion"), pentaxId, makerTags, unsignedByte, -1,
     printValue}, /* TODO: Decoding missing */
    {0x0028, "CPUFirmwareVersion", N_("CPUFirmwareVersion"), N_("CPUFirmwareVersion"), pentaxId, makerTags, unsignedByte, -1,
     printValue}, /* TODO: Decoding missing */
    {0x0029, "FrameNumber", N_("Frame number"), N_("Frame number"), pentaxId, makerTags, undefined, -1, printValue},
    /* Some missing ! */
    {0x002d, "EffectiveLV", N_("Light value"), N_("Camera calculated light value, includes exposure compensation"), pentaxId,
    ...
    {0x0038, "ImageAreaOffset", N_("Image area offset"), N_("Image area offset"), pentaxId, makerTags, unsignedLong, -1, printValue},
    {0x0039, "RawImageSize", N_("Raw image size"), N_("Raw image size"), pentaxId, makerTags, unsignedLong, -1, printValue},
    /* Some missing ! */
    {0x003e, "PreviewImageBorders", N_("Preview image borders"), N_("Preview image borders"), pentaxId, makerTags, unsignedByte, -1,
     printValue},
    {0x003f, "LensType", N_("Lens type"), N_("Lens type"), pentaxId, makerTags, unsignedByte, -1, printLensType}, // #816
    {0x0040, "SensitivityAdjust", N_("Sensitivity adjust"), N_("Sensitivity adjust"), pentaxId, makerTags, unsignedLong, -1,
     printValue},
    {0x0041, "DigitalFilter", N_("Digital filter"), N_("Digital filter"), pentaxId, makerTags, unsignedShort, -1,
     EXV_PRINT_TAG(pentaxOffOn)},
    /* Some missing ! */
    {0x0047, "Temperature", N_("Temperature"), N_("Camera temperature"), pentaxId, makerTags, signedByte, -1, printTemperature},
    {0x0048, "AELock", N_("AE lock"), N_("AE lock"), pentaxId, makerTags, unsignedShort, -1, EXV_PRINT_TAG(pentaxOffOn)},
    {0x0049, "NoiseReduction", N_("Noise reduction"), N_("Noise reduction"), pentaxId, makerTags, unsignedShort, -1,
     EXV_PRINT_TAG(pentaxOffOn)},
    /* Some missing ! */
    {0x004d, "FlashExposureCompensation", N_("Flash exposure compensation"), N_("Flash exposure compensation"), pentaxId, makerTags,
     signedLong, -1, printFlashCompensation},
    /* Some missing ! */
    {0x004f, "ImageTone", N_("Image tone"), N_("Image tone"), pentaxId, makerTags, unsignedShort, -1, EXV_PRINT_TAG(pentaxImageTone)},
    {0x0050, "ColorTemperature", N_("Color temperature"), N_("Color temperature"), pentaxId, makerTags, unsignedShort, -1, printValue},
    /* Some missing ! */
    {0x005c, "ShakeReduction", N_("Shake reduction"), N_("Shake reduction information"), pentaxId, makerTags, undefined, -1,
     printValue},
    {0x005d, "ShutterCount", N_("Shutter count"), N_("Shutter count"), pentaxId, makerTags, undefined, -1, printShutterCount},
    {0x0069, "DynamicRangeExpansion", N_("Dynamic range expansion"), N_("Dynamic range expansion"), pentaxId, makerTags, undefined, -1,
     EXV_PRINT_COMBITAG(pentaxDynamicRangeExpansion, 4, 0)},
    {0x0071, "HighISONoiseReduction", N_("High ISO noise reduction"), N_("High ISO noise reduction"), pentaxId, makerTags,
     unsignedByte, -1, EXV_PRINT_TAG(pentaxHighISONoiseReduction)},
    ...
    /* Some missing ! */
    {0x0205, "ShotInfo", N_("ShotInfo"), N_("ShotInfo"), pentaxId, makerTags, undefined, -1, printValue}, /* TODO: Decoding missing */
    {0x0206, "AEInfo", N_("AEInfo"), N_("AEInfo"), pentaxId, makerTags, undefined, -1, printValue}, /* TODO: Decoding missing */
    {0x0207, "LensInfo", N_("LensInfo"), N_("LensInfo"), pentaxId, makerTags, undefined, -1, printValue}, /* TODO: Decoding missing */
    {0x0208, "FlashInfo", N_("FlashInfo"), N_("FlashInfo"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    {0x0209, "AEMeteringSegments", N_("AEMeteringSegments"), N_("AEMeteringSegments"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    ...
    {0x020b, "FlashBDump", N_("FlashBDump"), N_("FlashBDump"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    /* Some missing ! */
    {0x020d, "WB_RGGBLevelsDaylight", N_("WB_RGGBLevelsDaylight"), N_("WB_RGGBLevelsDaylight"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    {0x020e, "WB_RGGBLevelsShade", N_("WB_RGGBLevelsShade"), N_("WB_RGGBLevelsShade"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    {0x020f, "WB_RGGBLevelsCloudy", N_("WB_RGGBLevelsCloudy"), N_("WB_RGGBLevelsCloudy"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    {0x0210, "WB_RGGBLevelsTungsten", N_("WB_RGGBLevelsTungsten"), N_("WB_RGGBLevelsTungsten"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    {0x0211, "WB_RGGBLevelsFluorescentD", N_("WB_RGGBLevelsFluorescentD"), N_("WB_RGGBLevelsFluorescentD"), pentaxId, makerTags,
     undefined, -1, printValue}, /* TODO: Decoding missing */
    {0x0212, "WB_RGGBLevelsFluorescentN", N_("WB_RGGBLevelsFluorescentN"), N_("WB_RGGBLevelsFluorescentN"), pentaxId, makerTags,
     undefined, -1, printValue}, /* TODO: Decoding missing */
    {0x0213, "WB_RGGBLevelsFluorescentW", N_("WB_RGGBLevelsFluorescentW"), N_("WB_RGGBLevelsFluorescentW"), pentaxId, makerTags,
     undefined, -1, printValue}, /* TODO: Decoding missing */
    {0x0214, "WB_RGGBLevelsFlash", N_("WB_RGGBLevelsFlash"), N_("WB_RGGBLevelsFlash"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    ...
    {0x0216, "BatteryInfo", N_("BatteryInfo"), N_("BatteryInfo"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    {0x021f, "AFInfo", N_("AFInfo"), N_("AFInfo"), pentaxId, makerTags, undefined, -1, printValue}, /* TODO: Decoding missing */
    {0x0222, "ColorInfo", N_("ColorInfo"), N_("ColorInfo"), pentaxId, makerTags, undefined, -1,
     printValue}, /* TODO: Decoding missing */
    {0x0229, "SerialNumber", N_("Serial Number"), N_("Serial Number"), pentaxId, makerTags, asciiString, -1, printValue},
    // End of list marker
    {0xffff, "(UnknownPentaxMakerNoteTag)", "(UnknownPentaxMakerNoteTag)", N_("Unknown PentaxMakerNote tag"), pentaxId, makerTags,
