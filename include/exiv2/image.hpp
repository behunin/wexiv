...
constexpr const char* photo_pix_X = "Exif.Photo.PixelXDimension";
constexpr const char* photo_pix_Y = "Exif.Photo.PixelYDimension";
constexpr const char* image_width = "Exif.Image.ImageWidth";
constexpr const char* image_length = "Exif.Image.ImageLength";
...
class EXIV2API Image {
 public:
  ...
  /*!
    ...
    */
  Image(int imageType, uint16_t supportedMetadata, BasicIo::UniquePtr io);
  //! Virtual Destructor
  ...
  /*!
    ...
    */
  virtual void setExifData(const emscripten::val& exifData);
  /*!
  ...
  /*!
    ...
    */
  virtual void setIptcData(const emscripten::val& iptcData);
  /*!
  ...
  /*!
    ...
    */
  virtual void setXmpData(const emscripten::val& xmpData);
  /*!
  ...
  /*!
    @brief Assign new image header data.

    @param headData An headData instance holding image header data to be copied
    */
  virtual void setHeadData(const emscripten::val& headData);
  /*!
    @brief Erase any Image header data.
    */
  virtual void clearHeadData();
  /*!
  ...
  /*!
    ...
    */
  virtual emscripten::val& exifData();
  /*!
    ...
    */
  virtual emscripten::val& iptcData();
  /*!
    ...
    */
  virtual emscripten::val& xmpData();
  /*!
    @brief Returns an headData instance containing image header data.

    The contained image header data may have been read from the image by
    a previous call to readMetadata() or added directly.

    @return modifiable headData instance containing image header data
    */
  virtual emscripten::val& headData();
  /*!
  ...
  /*!
    ...
    */
  virtual const emscripten::val& exifData() const;
  /*!
    @brief Returns an IptcData instance containing currently buffered
        IPTC data.
    ...
    @return modifiable IptcData instance containing IPTC values
    */
  virtual const emscripten::val& iptcData() const;
  /*!
    @brief Returns an XmpData instance containing currently buffered
        XMP data.
    ...
    @return modifiable XmpData instance containing XMP values
    */
  virtual const emscripten::val& xmpData() const;
  /*!
    @brief Returns an headData instance containing image header data.
    ...
    @return HeadData instance containing Image Header Data
    */
  virtual const emscripten::val& headData() const;
  /*!
